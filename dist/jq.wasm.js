var jq = function(jq2) {
  jq2 = jq2 || {};
  var Module = typeof jq2 !== "undefined" ? jq2 : {};
  ...
  Module = Object.assign({ noInitialRun: true, noExitRuntime: true, onRuntimeInitialized: function() {
    initialized = true;
  ...
  var wasmMemory;
  var wasmTable = new WebAssembly.Table({ "initial": 177, "maximum": 177 + 0, "element": "anyfunc" });
  var ABORT = false;
  var EXITSTATUS = 0;
  ...
  var DYNAMIC_BASE = 5575456, DYNAMICTOP_PTR = 332416;
  ...
  var FS = { root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, trackingDelegate: {}, tracking: { openFlags: { READ: 1, WRITE: 2 } }, ErrnoError: null, genericErrors: {}, filesystems: null, syncFSRequests: 0, handleFSError: function(e) {
    ...
    var stdin2 = FS.open("/dev/stdin", "r");
  ...
  var asmLibraryArg = { "a": ___assert_fail, "y": ___lock, "i": ___syscall195, "B": ___syscall197, "u": ___syscall199, "h": ___syscall221, "e": ___syscall5, "A": ___syscall54, "v": ___syscall85, "d": ___unlock, "j": _abort, "q": _emscripten_memcpy_big, "r": _emscripten_resize_heap, "s": _environ_get, "t": _environ_sizes_get, "b": _exit, "c": _fd_close, "g": _fd_fdstat_get, "w": _fd_read, "o": _fd_seek, "z": _fd_write, "D": _getpwuid, "m": _gmtime_r, "l": _localtime_r, "memory": wasmMemory, "n": _mktime, "C": _pathconf, "x": _round, "f": _strftime, "p": _strptime, "table": wasmTable, "k": _time };
  var asm = createWasm();
  Module["asm"] = asm;
  ...
  function raw(jsonstring, filter, flags) {
    ...
    if (errBuffer.length) {
      ...
      var err2 = new Error(errString);
      err2.stack = errBufferContents;
      throw err2;
    }
    return "";
  }
  function json(json2, filter) {
    if (!initialized)
      return {};
  ...
  jq2.json = json;
  jq2.raw = raw;
  jq2.onInitialized = { addListener: function(cb) {
    if (initialized) {
      cb();
    }
  ...
  jq2.promised = {};
  jq2.promised.json = function() {
    var args = arguments;
    return new Promise(function(resolve, reject) {
      jq2.onInitialized.addListener(function() {
        try {
          resolve(jq2.json.apply(jq2, args));
        } catch (e) {
          reject(e);
        }
      });
  ...
  jq2.promised.raw = function() {
    var args = arguments;
    return new Promise(function(resolve, reject) {
      jq2.onInitialized.addListener(function() {
        try {
          resolve(jq2.raw.apply(jq2, args));
        } catch (e) {
          reject(e);
        }
      });
